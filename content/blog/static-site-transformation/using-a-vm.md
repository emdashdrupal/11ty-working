...
One day I opened my VM to find it no longer had internet connectivity. My host (Windows) computer had access, other VMs I was testing had connectivity, so *something* happened to my working version. An hour or so searching and the answer was&hellip; well, I'm not sure. It's *possible* that it broke from an update, but I lost time trying to find the right magic commands. because it wasn't something easily done through the GUI.

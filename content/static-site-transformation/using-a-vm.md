...
When I said "some" time, that wasn't *entirely* accurate. You have to make some decisions, and test them, but some are actually fun.
...
Once you get over that curve, you mostly spend your time using cross-platform apps and technologies like VS Code, GitHub, and OpenOffice.
...
Fast-forward and I outgrew Mint. Kubuntu is my daily OS; it's so much more *customizable*.

...
A major part of my content strategy for this site was releasing blog posts on a regular cadence to drive traffic. As I updated my site, I documented the process through partially written Markdown files. I stored these stubs in a DON'T DELETE branch in my Git repository. Not quite best practice, but also not unusual to those who have had to clean up obsolete branches.

When it came time to pull one out of that branch, I decided the content reuse piece seemed to make sense. It followed an [AI-related post](/static-site-transformation/writing-with-ai) that was widely viewed (surprise!).
